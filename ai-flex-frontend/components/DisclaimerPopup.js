...
export function DisclaimerPopup({ isOpen, onClose }) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-white dark:bg-cyan-950 border border-cyan-700 sm:max-w-md">
        <DialogHeader className="border-b border-cyan-800 pb-4">
        ...
        <div className="space-y-4 py-2 text-sm text-cyan-950 dark:text-cyan-100">
          <p>
            ...
            <span className="text-red-500 font-semibold">does not</span> offer{" "}
        ...
        <DialogFooter className="pt-2 border-t border-cyan-800">
          <Button
            onClick={onClose}
